package com.ai.modules.interview.listener;

import com.ai.common.async.AbstractStreamConsumer;
...
import com.ai.modules.interview.model.InterviewSessionEntity;
import com.ai.modules.interview.respority.InterviewSessionRepository;
import com.ai.modules.interview.service.AnswerEvaluationService;
...
public class EvaluateStreamConsumer extends AbstractStreamConsumer<EvaluateStreamConsumer.EvaluatePayload> {
    ...
    protected void processBusiness(EvaluatePayload payload) {
        ...
        List<com.ai.modules.interview.model.InterviewAnswerEntity> answers =
                persistenceService.findAnswersBySessionId(sessionId);
        for (com.ai.modules.interview.model.InterviewAnswerEntity answer : answers) {
