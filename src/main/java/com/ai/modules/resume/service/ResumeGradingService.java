...
import com.ai.modules.interview.model.ResumeAnalysisResponse.ScoreDetail;
import com.ai.modules.interview.model.ResumeAnalysisResponse.Suggestion;
...
public class ResumeGradingService {
    ...
    // 使用BeanOutputConverter将ai响应转化成java对象,类似于.entity方法
    ...
    public ResumeAnalysisResponse analyzeResume(String resumeText) {
        ...
        try {
            ...
            // 将简历文本内容填充到用户提示词中{resumeText}的位置
